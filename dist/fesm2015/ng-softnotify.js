 ...
 */
const shrink = animation(animate('{{time}}', style({ height: '0px', paddingTop: '0px', paddingBottom: '0px', marginTop: '0px', marginBottom: '0px' })), { params: { time: '200ms' } });
 ...
 */
function useSlideFadeInAnimation(time = '200ms', startPos = '100%') {
 ...
 */
function useSlideFadeOutAnimation(time = '200ms', endPos = '100%') {
 ...
 * @param time the duration of the animation
 */
function useGrowInAnimation(time = '200ms') {
    return useAnimation(growIn, { params: { time } });
}
const shrinkOut = animation(group([
    useAnimation(shrink, { params: { time: '{{time}}' } }),
 ...
 * @param time the duration of the animation
 */
function useShrinkOutAnimation(time = '200ms') {
 ...
 * @param time the duration of the animation
 */
function useSwingInAnimation(time = '600ms') {
 ...
 * @param time the duration of the animation
 */
function useSwingOutAnimation(time = '300ms') {
 ...
 * @param time the duration of the animation
 */
function useBounceInUpAnimation(time = '200ms') {
 ...
 * @param time The duration of the animation
 */
function useBounceOutDownAnimation(time = '200ms') {
 ...
 */
const bounceInAndOut = trigger('bounceInAndOut', [
 ...
 */
const growInShrinkOut = trigger('growInShrinkOut', [
 ...
 */
const enterAndLeaveFromRight = trigger('enterAndLeaveFromRight', [
 ...
 */
const enterAndLeaveFromLeft = trigger('enterAndLeaveFromLeft', [
 ...
 */
const fadeInAndOut = trigger('fadeInAndOut', [
 ...
 */
const swingInAndOut = trigger('swingInAndOut', [
 ...
 */
const fadeInThenOut = trigger('fadeInThenOut', [
